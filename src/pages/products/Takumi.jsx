...
import takumiLogo from '../../assets/Takumi-home.png'
import { HiOutlineScale, HiOutlineLightBulb, HiOutlineEye, HiOutlineHand } from "react-icons/hi";
...
const Takumi = () => {
    ...
    const features = [
  {
    ...
    description: "Comprehensive, multi-asset visibility across equities, fixed income, commodities, FX, derivatives, and digital assets globally."
  },
  {
    icon: HiOutlineLightBulb,
    title: "Real-Time Vigilance Meets Historical Wisdom",
    description: "Immediate red flag detection with real-time monitoring combined with deep historical analysis to uncover subtle, evolving behavioral patterns."
  },
  {
    icon: HiOutlineEye,
    title: "The Need for Rapid Analytics",
    description: "A rich set of pre-configured analytics with easy configuration and the ability to rapidly develop new patterns to adapt faster than fraudsters."
  },
  {
    icon: HiOutlineHand,
    title: "Compliance Without Chaos: Built-in Auditing",
    description: "A 'black box' for every action, exhaustive audit reports, and full historical traceability showing what happened, when, why, and by whom."
  }
];
                ...
                <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className="mb-6 flex flex-row items-center justify-center gap-x-6">
                        <div className="inline-flex items-center justify-center  transition-transform duration-300">
                            <img src={takumiLogo} alt="ValetPlus" className="w-84 " />
                        </div>
                    ...
                    <div className="max-w-4xl mx-auto mb-12">
                        <blockquote className="text-2xl md:text-3xl lg:text-4xl font-light text-slate-600 leading-relaxed mb-4">
                            "Takumi empowers organizations to see beyond the trade by delivering clarity, control, and compliance in every transaction."
                        </blockquote>
                    </div>
                    ...
                    <div className="mb-20">
                        <a
                            href="https://takumi-platform.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group inline-flex items-center gap-3 bg-gradient-to-r from-[#143e5b] to-[#0c293d] hover:from-[#0c293d] hover:to-[#143e5b] text-white font-semibold px-8 py-4 rounded-full shadow-xl hover:shadow-2xl transform  transition-all duration-300 text-lg"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="mb-6">
                                    <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-[#143e5b] to-[#0c293d] rounded-xl group-hover:scale-110 transition-transform duration-300">
                                        <feature.icon className="w-7 h-7 text-white" strokeWidth={2} />
                                    </div>
                                </div>

                                <h3 className="text-xl font-bold text-gray-500 mb-4 group-hover:text-[#0c293d] transition-colors duration-300">
                                    {feature.title}
                                </h3>
                                ...
                                <div className="w-0 group-hover:w-full h-0.5 bg-gradient-to-r from-[#143e5b] to-[#0c293d] transition-all duration-500 mt-6 rounded-full"></div>
                            </div>
                        ))}
                    </div>
                </div>
