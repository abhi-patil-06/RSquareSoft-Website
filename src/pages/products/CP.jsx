    ...
    return (
        <main className="bg-white text-gray-900 font-sans">
            ...
            <section
                ...
                style={{ backgroundColor: lightBgColor }} // Very light background
            >
                ...
                <svg className="absolute top-0 left-0 w-full h-full pointer-events-none" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
                    <path fill={subtlePurple} d={blobPaths[0]} transform="translate(100 100) scale(2.5) rotate(15)" />
                    <path fill={subtlePurple} d={blobPaths[0]} transform="translate(1300 800) scale(5) rotate(35)" />
                    <path fill={subtleYellow} d={blobPaths[1]} transform="translate(1000 200) scale(1.9) rotate(-30)" />
                    {/* <path fill={subtlePurple} d={blobPaths[2]} transform="translate(200 800) scale(0.9) rotate(45)" /> */}
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-4xl px-4">
                    ...
                    {/* Kaarmika Logo */}
                    <img
                        src="public\logo\ValetPlus2.png" // Your Kaarmika logo
                        alt="Kaarmika Logo"
                    ...
                    <a
                        href="https://www.valetplus.net" // Link to Kaarmika landing page
                        target="_blank"
            ...
            <section id="why" className="py-40 px-6 md:px-16" style={{ backgroundColor: veryLightGray }}>
            ...
            <section className="py-20 px-6 md:px-16" style={{ backgroundColor: lightBgColor }}>
                <div className="max-w-7xl mx-auto">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            width: 'fit-content',
                            border: `2px solid ${primaryPurple}`, // Solid border
                        }}
                    >
                        ...
                        >
                            ...
                            <div className="absolute bottom-8 left-8 flex items-center space-x-4 bg-white p-4 rounded-full shadow-lg">
                                <img
                                    ...
                                    style={{ borderColor: accentYellow }} // Yellow border for image
                                />
                                <div className="text-left">
