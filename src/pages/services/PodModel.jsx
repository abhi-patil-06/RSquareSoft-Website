...
import { processSteps, benefits, useCases, faqs,technologies, stats } from '../../data/serviceData/podModelData';
import podModelImg from "../../assets/podModel.jpeg"
import { serviceOverviewData } from '../../data/serviceData/podModelData';




export default function PodModel() {
          ...
          >
            ...
            <nav className="absolute -top-7 md:top-15 text-white font-bold text-lg md:text-2xl uppercase">
              ...
              <div className="flex space-x-3">
                <span >Service</span>
                <span>/</span>
                <span >POD Model ( Fixed Price )</span>
              </div>
